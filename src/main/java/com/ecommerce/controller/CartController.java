...
public class CartController {
    ...
    public ResponseEntity<CartProductDTO> addProductToCart(@PathVariable("cartId") final Long cartId, @RequestBody final AddCartProductDTO addCartProductDTO) {
        return new ResponseEntity<>(cartService.addProductToCart(addCartProductDTO), HttpStatus.OK);
    }
}
